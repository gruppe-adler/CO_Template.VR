...
private _opticModes = "true" configClasses (configFile >> "CfgWeapons" >> _optic >> "ItemInfo" >> "OpticsModes");
private _opticsZoomMin = 1000;
{
...
private _zoomFactor = 0.25/_opticsZoomMin;
_zoomFactor
