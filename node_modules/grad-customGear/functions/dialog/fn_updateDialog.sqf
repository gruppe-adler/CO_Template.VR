...
private _dialog = findDisplay sd_mainIDD;
if (isNull _dialog) exitWith {};

//get gear
private _myID = [mcd_coTemplate_customGearArray, getplayerUID player] call grad_customgear_fnc_findUID;
...
//get current gear
private _curHelmet = headgear player;
private _curGoggles = goggles player;
private _curScope = (player weaponAccessories (primaryWeapon player)) select 2;
