...
*   Beispiel1: Nicht- und mehrfachvergrößernde Visiere sind erlaubt. Im Missionsloadout ist einem Spieler ein Rotpunktvisier vorgesehen. Bei Missionsstart wird er deshalb trotzdem nur das nichtvergrößernde Visier laden können.
